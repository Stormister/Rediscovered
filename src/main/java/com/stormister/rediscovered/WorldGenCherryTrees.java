...
public class WorldGenCherryTrees extends WorldGenAbstractTree
{
            ...
            else
            {
                ...
                if (isSoil && p_180709_3_.getY() < 256 - i - 1)
                {
                        ...
                        for (k1 = p_180709_3_.getX() - j1; k1 <= p_180709_3_.getX() + j1; ++k1)
                        {
                            ...
                            for (int i2 = p_180709_3_.getZ() - j1; i2 <= p_180709_3_.getZ() + j1; ++i2)
                            {
                                ...
                                if (Math.abs(l1) != j1 || Math.abs(j2) != j1 || p_180709_2_.nextInt(2) != 0 && i1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(worldIn, blockpos1, mod_Rediscovered.CherryLeaves.getStateFromMeta(metaLeaves));
                                    }
                                }
                            }
                        }
                    ...
                    for (l = 0; l < i; ++l)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(worldIn, p_180709_3_.up(l), mod_Rediscovered.CherryLog.getStateFromMeta(metaWood));
                        }
                    }
    ...
    {
        this.setBlockAndNotifyAdequately(worldIn, p_175923_2_, Blocks.vine.getDefaultState());
        int j = 4;
