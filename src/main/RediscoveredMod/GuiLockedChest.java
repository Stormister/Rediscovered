...
public class GuiLockedChest extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        byte b0 = -16;
        this.buttonList.add(new GuiButton(0, this.width / 2 - 107, this.height / 6 + 130, 98, 20, I18n.getString("Not Now")));
        this.buttonList.add(new GuiButton(1, this.width / 2 + 10, this.height / 6 + 130, 98, 20, I18n.getString("Go to store")));
    }
