...
public class WorldGenOceanBlocks extends WorldGenerator
{
    ...
    public WorldGenOceanBlocks(int par1, int par2)
    {
        this(par1, par2, Block.sand.blockID);
    }

    public WorldGenOceanBlocks(int par1, int par2, int par3)
    {
    ...
    public WorldGenOceanBlocks(int id, int meta, int number, int target)
    {
