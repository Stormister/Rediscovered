...
public class ItemGear extends Item
{
    ...
    public ItemGear(int par1, String texture)
    {
        super(par1);
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            else if (!mod_Rediscovered.GearFloor.canPlaceBlockAt(par3World, par4, par5, par6) && !mod_Rediscovered.GearWall.canPlaceBlockAt(par3World, par4, par5, par6))
            {
                return false;
            }
            else
            {
                if (par7 == 1 && mod_Rediscovered.GearFloor.canPlaceBlockAt(par3World, par4, par5, par6) && mod_Rediscovered.GearWall.canPlaceBlockAt(par3World, par4, par5, par6))
                {
                    ...
                    par3World.setBlock(par4, par5, par6, mod_Rediscovered.GearFloor.blockID, i1, 2);
                }
                ...
                {
                	par3World.setBlock(par4, par5, par6, mod_Rediscovered.GearWall.blockID, par7, 2);
                }
