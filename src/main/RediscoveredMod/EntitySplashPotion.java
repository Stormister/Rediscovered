...
public class EntitySplashPotion extends EntityThrowable
{
    ...
    public EntitySplashPotion(World par1World)
    {
        super(par1World);
    }

    public EntitySplashPotion(World par1World, EntityLiving par2EntityLiving, int par3)
    {
        this(par1World, par2EntityLiving, new ItemStack(Item.potion, 1, par3));
    }

    public EntitySplashPotion(World par1World, EntityLiving par2EntityLiving, ItemStack par3ItemStack)
    {
    ...
    public EntitySplashPotion(World par1World, double par2, double par4, double par6, int par8)
    {
        this(par1World, par2, par4, par6, new ItemStack(Item.potion, 1, par8));
    }

    public EntitySplashPotion(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
    {
