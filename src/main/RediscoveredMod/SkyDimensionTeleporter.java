        ...
        for (int var14 = -2; var14 <= 2; ++var14)
   {
        for (int var15 = -2; var15 <= 2; ++var15)
        {
         for (int var16 = -1; var16 < 3; ++var16)
         {
          ...
          this.field_85192_a.setBlock(var17, var18, var19, var20 ? Block.glowStone.blockID : 0);
         }
        }
   }
	  ...
	  else
	  {
		  for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
		  {
			  ...
			  for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
			  {
				  ...
				  {
					  if (mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var48, var26, var23) == mod_Rediscovered.DreamBed.blockID)
					  {
						  while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == mod_Rediscovered.DreamBed.blockID)
						  {
							  --var26;
						  }
					  ...
					  else if (!mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var48, var26, var23) == Block.bed.blockID)
					  {
						  while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == Block.bed.blockID)
						  {
							  --var26;
						  }
						  var27 = (double) var26 + 0.5D - par1Entity.posY;
	   ...
	   if (var10 >= 0.0D)
	   {
		   ...
		   int var50 = -1;
		   if ((mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12 - 1, var13, var14) == mod_Rediscovered.DreamBed.blockID) || (!mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Block.bed.blockID))
		   {
			   var50 = 2;
		   }
		   if ((mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12 + 1, var13, var14) == mod_Rediscovered.DreamBed.blockID) || (!mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Block.bed.blockID))
		   ...
		   if ((mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12, var13, var14 - 1) == mod_Rediscovered.DreamBed.blockID) || (!mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Block.bed.blockID))
		   {
			   var50 = 3;
		   }
		   if ((mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12, var13, var14 + 1) == mod_Rediscovered.DreamBed.blockID) || (!mod_Rediscovered.DreamBedEnabled && this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Block.bed.blockID))
        ...
        for (var19 = -1; var19 <= 1; ++var19)
   {
        for (var20 = 1; var20 < 3; ++var20)
        {
         for (var21 = -1; var21 < 3; ++var21)
         {
          ...
          var33 = var21 < 0;
          this.field_85192_a.setBlock(var22, var23, var24, var33 ? 0 : 0);
         }
        }
   }
  }
