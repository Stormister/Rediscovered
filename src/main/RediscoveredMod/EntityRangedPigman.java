...
import RediscoveredMod.EntityParrow;
...
public class EntityRangedPigman extends EntityMob implements IRangedAttackMob
{
    ...
    {
        EntityParrow entityarrow = new EntityParrow(this.worldObj, this, par1EntityLivingBase, 1.6F, (float)(14 - this.worldObj.difficultySetting * 4));
    ...
    {
        return (dataWatcher.getWatchableObjectByte(13) & 1) != 0;
    }

    public void func_48115_b(boolean par1)
    {
        byte byte0 = dataWatcher.getWatchableObjectByte(13);

        if (par1)
        {
            dataWatcher.updateObject(13, Byte.valueOf((byte)(byte0 | 1)));
        }
        else
        {
            dataWatcher.updateObject(13, Byte.valueOf((byte)(byte0 & -2)));
        }
    }
}
