...
public class WorldGenBigCherryTrees extends WorldGenerator
{
    /**
    ...
    public WorldGenBigCherryTrees(boolean par1)
    {
        super(par1);
    }
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                else
                {
                    ...
                    if (l1 != 0 && l1 != mod_Rediscovered.CherryLeaves.blockID)
                    {
                        ++k1;
                    }
                    else
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.genTreeLayer(par1, l, par3, f, (byte)1, mod_Rediscovered.CherryLeaves.blockID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(aint, aint1, mod_Rediscovered.CherryLog.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.placeBlockLine(aint, aint2, mod_Rediscovered.CherryLog.blockID);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        else
        {
            ...
            for (j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                if (k != 0 && k != mod_Rediscovered.CherryLeaves.blockID)
                {
                    break;
                }
            }
