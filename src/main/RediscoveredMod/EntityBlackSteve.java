...
public class EntityBlackSteve extends EntityMob
{
    ...
    public EntityBlackSteve(World par1World)
    {
        ...
        tasks.addTask(12, new EntityAIWatchClosest2(this, RediscoveredMod.EntityBlackSteve.class, 5F, 0.02F));
    ...
    protected void dropRareDrop(int par1)
    {
        if (par1 > 0)
        {
            ItemStack itemstack = new ItemStack(Item.flintAndSteel);
            entityDropItem(itemstack, 0.0F);
        }
        else
        {
            dropItem(Item.flintAndSteel.itemID, 1);
        }
    }
