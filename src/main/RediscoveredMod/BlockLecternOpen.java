...
public class BlockLecternOpen extends BlockContainer
{
    ...
    protected BlockLecternOpen(int par1)
    {
     ...
     * Returns a new instance of a block's tile entity class. Called on placing the block.
     */
    public TileEntity getTileEntity(World par1World)
    {
        return this.createNewTileEntity(par1World);
    }
    
    @Override
    public int getRenderType()
    {
        return mod_Rediscovered.rendererLecternOpenId;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        par1World.setBlock(par2, par3, par4, mod_Rediscovered.Lectern.blockID);
    ...
    {
        return mod_Rediscovered.Lectern.blockID;
    }
